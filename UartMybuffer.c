...
My_buffer rx_buffer = { { 0 }, 0, 0};
My_buffer tx_buffer = { { 0 }, 0, 0};

My_buffer *_rx_buffer;
My_buffer *_tx_buffer;

void store_char(unsigned char c, My_buffer *buffer);


void Mybuffer_init(void)
{
